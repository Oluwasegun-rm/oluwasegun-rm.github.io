;(function () {
	...
	var navigationSection = function() {
		...
		var activateCurrentSection = function() {
			...
			// The final section may never reach the Waypoints offset if the page
			// cannot scroll past it, so explicitly activate it at the bottom.
			if (scrollTop + windowHeight >= documentHeight - 5) {
				navActive($section.last().data('section'));
				return;
			}

			$section.each(function() {
				var $this = $(this),
					sectionTop = $this.offset().top - 160,
		...
		$(window).on('scroll resize', activateCurrentSection);
